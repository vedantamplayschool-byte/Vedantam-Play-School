...
const schema = new mongoose.Schema(
  {
    ...
    // True when these credentials were generated automatically at
    // enrollment time rather than set manually by an admin. The generated
    // password itself is never persisted in plaintext — only its bcrypt
    // hash (in `password`) — it is returned once in the API response at
    // creation time so the admin can copy/share it immediately.
