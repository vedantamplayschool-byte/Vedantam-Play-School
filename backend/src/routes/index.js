...
r.use('/notices', crudRouter(Notice, { isPublished: true, $or: [{ expiresAt: { $exists: false } }, { expiresAt: null }, { expiresAt: { $gte: new Date() } }] }, ['title', 'body']));
...
r.use('/students', crudRouter(Student, {}, ['studentName', 'parentName', 'phone']));
